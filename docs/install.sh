#!/bin/bash
# Elitzur Games — Voice Chat auto-installer (macOS / Linux)
...
echo -e "\033[33m Elitzur Games — Voice Chat Installer\033[0m"
echo -e "\033[33m==========================================\033[0m"
...
ok "Fabric API → $MODS_DIR/fabric-api-0.150.0+26.1.2.jar"
curl -fsSL "$VOICECHAT" -o "$MODS_DIR/voicechat-fabric-2.6.18+26.1.2.jar"
ok "Voice Chat → $MODS_DIR/voicechat-fabric-2.6.18+26.1.2.jar"
...
echo "2. בחר את הפרופיל 'Elitzur Games (Fabric $MC_VERSION)' (או fabric-loader-$MC_VERSION)"
echo "3. לחץ Play"
